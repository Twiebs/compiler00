...
if:                                               ; preds = %entry
  call void @Println(i8* getelementptr inbounds ([6 x i8]* @str, i32 0, i32 0))
  br label %merge

else:                                             ; preds = %entry
  call void @Println(i8* getelementptr inbounds ([5 x i8]* @str1, i32 0, i32 0))
  br label %merge
}
