...
@str6 = private unnamed_addr constant [23 x i8] c"Running boolean test!\0A\00"
@str7 = private unnamed_addr constant [23 x i8] c"Foo is greater than 1\0A\00"
@str8 = private unnamed_addr constant [22 x i8] c"Foo is less than 1.0\0A\00"
...
entry:
  ...
  %0 = load float* %foo
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @str1, i32 0, i32 0), float %0)
  %bar = alloca i32
  store i32 8, i32* %bar
  %1 = load i32* %bar
  ...
  %3 = load i32* %bar
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([13 x i8]* @str2, i32 0, i32 0), i32 %3)
  %4 = load float* %foo
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @str3, i32 0, i32 0), float %4)
  %someInt = alloca i32
  store i32 0, i32* %someInt
  store i32 6, i32* %someInt
  %5 = load i32* %someInt
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([16 x i8]* @str4, i32 0, i32 0), i32 %5)
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @str5, i32 0, i32 0))
  ret void
}
...
entry:
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @str6, i32 0, i32 0))
  %foo = alloca float
...
if:                                               ; preds = %entry
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @str7, i32 0, i32 0))
  br label %merge

merge1:                                           ; preds = %if2, %merge
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([2 x i8]* @str9, i32 0, i32 0))
  ret void

if2:                                              ; preds = %merge
  call void (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @str8, i32 0, i32 0))
  br label %merge1
}
